#!/usr/bin/env python
# coding=utf-8
# 快速TCP端口探测，发现指定主机上开放的TCP端口
# 调用方法：python tcp_port_detect.py 10.10.10.1 [debug/release]
...
nm.scan(hosts ,arguments="-sS -F")

for tcp_port in nm[hosts].all_tcp():
    print "Host:",hosts,"Tcp:",tcp_port
